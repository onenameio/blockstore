...
use libsigner::v0::messages::{
    ...
    RejectCode, RejectCodeTypePrefix, SignerMessage,
};
...
impl Signer {
    ...
    fn compute_reject_code_signing_weight<'a>(
        &self,
        addrs: impl Iterator<Item = &'a (StacksAddress, RejectCodeTypePrefix)>,
        reject_code: RejectCodeTypePrefix,
    ) -> u32 {
    ...
    fn handle_block_rejection(
        ...
        let total_reorg_reject_weight = self.compute_reject_code_signing_weight(
            ...
            RejectCodeTypePrefix::ReorgNotAllowed,
        );
